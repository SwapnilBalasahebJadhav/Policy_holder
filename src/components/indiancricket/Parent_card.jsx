...
import IndianCricket_card from './IndianCricket_card';
  ...
  <div className="row recomendedvideo">
  {
    data.map((item)=>{
        return(
            ...
            <IndianCricket_card video={item.vid} img={item.img} title={item.title} avatar={item.avatar} channel={item.channel} views={item.views} date={item.date}/>
